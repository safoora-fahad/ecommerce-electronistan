...
for (let i =0;i<localStorage.length;i++){
  ...
  <td scope="col" colspan="2"><button onclick = "plusBtn(this)" class="min-btn">+</button> <span> ${jsonData.quantity}</span><button onclick = "minusBtn(this)" class="plus-btn">-</button></td>
  <td scope="col" colspan="2" class="priceClass">${jsonData.price.split('PKR').join('')} PKR</td>
  <td scope="col" colspan="2"><button onclick ="deleteItem(this)" class="item-dlt">Delete</button></td>
  </tr>
  `
}}
updateCart()
